        ...
        <div class="z-10 absolute top-0 inset-x-0 p-2">
            <header class="flex justify-between items-center">
                ...
                <div class="flex items-center">
                    <?php if ($withToday): ?>
                        <ui-calendar-today behavior="select" class="size-10 sm:size-8 rounded-lg flex items-center justify-center text-zinc-400 hover:bg-zinc-100 hover:text-zinc-800 dark:hover:bg-white/5 dark:hover:text-white [&[disabled]]:opacity-50 [&[disabled]]:pointer-events-none" aria-label="{{ __('Go to today') }}">
                            <div class="relative">
                                <template name="today">

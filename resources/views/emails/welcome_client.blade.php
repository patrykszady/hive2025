...
<div style="text-align: center; margin: 0 0 18px 0;">
	<p style="margin: 0 auto; max-width: 560px; color: #374151; font-size: 15px; line-height: 1.65; text-align: center;">
		<strong style="color: #111827;">{{ $contractorName }}</strong> uses
		<a href="{{ $appUrl }}" style="color: #4f46e5; text-decoration: none; font-weight: 700;">Hive Contractors</a>
		to manage your project. Register today to access your schedule, project updates, and stay connected with {{ $contractorName }}.
	</p>
</div>

...
@php
    $heading = $heading ?? __('Working with a Hive contractor?');
    $subheading = $subheading ?? __('Just tap the invite link they sent you to see your project. Lost it? Ask them to resend it—it only takes a second.');
@endphp

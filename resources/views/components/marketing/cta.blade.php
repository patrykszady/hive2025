...
@php
    $heading = $heading ?? __('Run your whole business from one Hive.');
    $subheading = $subheading ?? __('Join the contractors automating their finances, scheduling, and client updates—so they can get back to building.');
@endphp

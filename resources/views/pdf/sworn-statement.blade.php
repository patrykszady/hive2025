...
<head>
    ...
    <style>
        ...
        /* Captions hang below their rule (see .cap), so a line that has one
           needs room underneath or it collides with the next line. */
        .ln:has(.fld) { margin-bottom: 11px; }
        ...
        /* height:0 takes the caption out of the column's box, so flex-end
           aligns the RULE with the surrounding text baseline (an empty field
           otherwise floats its rule a whole caption-height too high) and the
           caption hangs underneath it. */
        .ln .fld .cap { font-size: 6.5pt; text-align: center; letter-spacing: 0.02em; height: 0; line-height: 1.1; overflow: visible; }
...
@endphp
    ...
    <div class="ln"><span class="lbl">The affiant,</span><span class="fld"><span class="uline">&nbsp;</span><span class="cap">(NAME)<span class="req-star">*</span></span></span><span class="lbl sfx">being first duly sworn, on oath deposes and says that he/she is</span></div>

                ...
                <div
                    ...
                    <form wire:submit="store" x-show="showRegister">
                        <button
                            ...
                            class="inline-flex justify-center w-full px-4 py-2 text-lg font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-xs disabled:opacity-50 hover:bg-indigo-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                            >
    ...
    <div
        ...
        <div
            ...
            <div
                ...
                >
                <button type="button" class="inline-flex items-center px-4 py-2 text-sm font-semibold leading-6 text-white transition duration-150 ease-in-out bg-indigo-800 rounded-md shadow-sm hover:bg-indigo-600" disabled="">

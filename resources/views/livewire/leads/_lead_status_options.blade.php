...
<flux:select.option value="Message 1"><flux:badge color="sky">Message 1</flux:badge></flux:select.option>
<flux:select.option value="Message 2"><flux:badge color="sky">Message 2</flux:badge></flux:select.option>
<flux:select.option value="Message 3"><flux:badge color="sky">Message 3</flux:badge></flux:select.option>

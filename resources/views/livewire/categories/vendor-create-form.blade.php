        ...
        <form wire:submit="save">
            ...
            <x-cards.footer>
                <button
                    ...
                    class="px-4 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded-md shadow-xs font-small hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                    Cancel
                </button>

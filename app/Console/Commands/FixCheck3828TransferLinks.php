...
class FixCheck3828TransferLinks extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:fix-check3828-transfer-links';
     ...
     * @var string
     */
    protected $description = 'Relink check 3828 to the three before-check Venmo transfers (28815, 28869, 28913) and unlink the post-check transfer (28916)';
    ...
    public function handle(): int
    {
        ...
        $alreadyCorrect = collect($correctIds)->every(fn ($id) => $transactions[$id]->check_id === $checkId)

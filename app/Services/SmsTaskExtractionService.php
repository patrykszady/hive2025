...
checklist: ALWAYS capture every distinct actionable to-do described in the message — including side tasks in parentheses or follow-ups for another day — as a short, capitalized imperative phrase (e.g. "let's adjust your ring cameras" -> ["Adjust Ring cameras"]; "go over logistics and details" -> ["Go over logistics and details"]). Do not repeat the title verbatim as a checklist item. Empty array only when there are no actionable items beyond the main task.
...
{"has_task": true, "title": "Onsite Visit", "type": "Task", "date": "2025-03-02", "start_time": null, "end_time": null, "project_hint": "", "assignee_names": ["Greg"], "checklist": ["Adjust Ring cameras"]}
...
PROMPT;
        ...
        $schema = [
            ...
            'required' => ['has_task', 'title', 'type', 'date', 'start_time', 'end_time', 'project_hint', 'assignee_names', 'checklist'],
            'properties' => [
    ...
    protected function normalize(array $parsed): array
    {
        ...
        return [
            ...
            'start_time' => $this->cleanString($parsed['start_time'] ?? null),
            'end_time' => $this->cleanString($parsed['end_time'] ?? null),

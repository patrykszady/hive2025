...
Schedule::call('\App\Http\Controllers\CompanyEmailController@fetchMessagesForGrantId')->everyTenMinutes();
Schedule::call('\App\Http\Controllers\LeadController@leads_in_email')->everyTenMinutes();

Schedule::call('\App\Http\Controllers\CompanyEmailController@fetchAutoReceipts')->everyTenMinutes();
